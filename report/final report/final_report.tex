...
manage. With Prophasis management of the entire system can be handled from a
single, responsive web interface. Prophasis is also suitable as a one-stop tool
with support for both time series monitoring in addition to real time alerting.
Whereas traditionally two different tools would be needed to gain this level of
monitoring.  Prophasis also has extensive support for custom plugins to enable
data to be collected from a huge variety of different software and hardware.}
%TODO Expand Abstract - length limit?
...
\paragraph*{Windows Support}
	...
	Windows. %TODO - How did we fix this?
