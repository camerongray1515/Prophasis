...
investigated as they focus on time series monitoring.
...
\label{classification-threshold-definitions}
	...
	Because Munin and Collectd do not support real time alerting, there is no
	support for classifying data.
...
\subsection{How the user configures the system}
	...
	configuration files stored on disk.
...
\subsection{How Dependencies are Handled}
	...
	have no dependency functionality due to its lack of real time alerting.
