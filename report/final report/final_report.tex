...
\paragraph*{Ideas for Future Work}
	...
	check the free space on different disks.
...
%TODO - Future work
%    Arguments to plugins on a check by check basis
%    Pull data from different plugins into classification logic
%    Distributed monitoring
%    Server-side plugins that check remote systems
